    ...
    <>
      ...
      <section className="container relative mx-auto py-12 md:py-24 px-4 md:px-6 text-center overflow-hidden">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="relative p-1 rounded-xl bg-gradient-to-r from-purple-500 to-fuchsia-400">
            <div className="absolute inset-0 blur-xl bg-gradient-to-r from-purple-500 to-fuchsia-400 opacity-50"></div>
            <div className="relative rounded-lg overflow-hidden">
              <img
                src="https://i.ibb.co/wSGVbJ9/Capture.png"
                alt="Nodistribute Wallet Interface"
